...
该版本新增 `insertDocs [2/3]`，用于快速插入[新版文档转换服务](./advanced-features/convert-files)转换后的 PDF/PPTX 文档。

<ListTitle>操作 PDF/PPTX 文档</ListTitle>

该版本新增 `dispatchDocsEvent`，用于向插入白板的 PDF/PPTX 文档发送事件，实现代码控制文档翻页、页面跳转和幻灯片动画播放。
